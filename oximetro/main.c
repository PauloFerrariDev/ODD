...
// ***** End Initialization  *****
    ...
    ssd1306_printText(64, 3, "Oi nec orci ornare consequat. Praesent lacinia ultrices consectetur. Sed non ipsum felis. Manduma pindureta quium dia nois paga.");
    //ssd1306_drawBitmapUTFPR();
